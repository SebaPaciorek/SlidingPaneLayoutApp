...
class SportsListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // When the list and detail panes overlap on smaller screens like phones,
        // users can swipe in both directions by default, freely switching between the two panes
        // even when not using gesture navigation. You can lock or unlock the details pane
